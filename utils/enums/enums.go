...
var ExcelMultibandaHeaders = map[string]string{
	"A1":  "Client",
	"B1":  "Brand",
	"C1":  "Commercial Model",
	"D1":  "Technical Model",
...
var ExcelShipmentControlHeaders = map[string]string{
	"A1":  "Client",
	"B1":  "Company",
	"C1":  "Country",
	"D1":  "Brand",
	...
	"I1":  "Hardware Version",
	"J1":  "OS Version",
	"K1":  "Subtel Certificate Number",
	"L1":  "Phase",
	"M1":  "Status",
	"N1":  "Planning Date",
	"O1":  "Validation Start Date",
	"P1":  "Validation End Date",
	"Q1":  "Under Revision Start Date",
	"R1":  "Under Revision End Date",
	"S1":  "Completed Date",
	"T1":  "IMEI Quantity",
	"U1":  "Registered IMEI Count",
	"V1":  "Rework Number",
	"W1":  "OABI Certificate Number",
	"X1":  "Comment",
}
